    ...
    <div className="min-h-screen">
      ...
      <ScrollArea className="h-screen w-full">
        <Nav defaultValue="about">
          ...
          <TabsContent value="portfolio" className="max-w-3xl mx-auto px-6">
            <div className="text-white/60">
              Portfolio content coming soon...
            </div>
          </TabsContent>

          <TabsContent value="blog" className="max-w-3xl mx-auto px-6">
            <div className="text-white/60">Blog content coming soon...</div>
          </TabsContent>
        </Nav>
      </ScrollArea>
    </div>
