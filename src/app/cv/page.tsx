  ...
  },
  {
    ...
    body: (
      <>
        ...
        ASR, diarization, and passage-level semantic search. Stack: Dagster
...
function Section({
  ...
  return (
    <section className="mt-8">
      ...
      {intro && (
        <p className="text-soft text-[10pt] leading-[1.6] mb-4">{intro}</p>
      )}
          ...
          <div key={b.title}>
            <div className="flex items-baseline justify-between gap-3 mb-1">
              <h3 className="text-[11pt] font-medium tracking-[-0.02em] text-ink">
                {b.title}
                {b.years && (
                  <span className="ml-2 text-[9.5pt] font-normal text-muted tracking-[-0.005em]">
                    ({b.years})
                  </span>
                )}
              </h3>
            ...
            <p className="text-body text-[10pt] leading-[1.6]">{b.body}</p>
          </div>
        ))}
      </div>
    </section>
  ...
  return (
    ...
    <div className="max-w-[var(--content-width)] mx-auto px-6 md:px-10 pt-8 pb-24 text-[10.5pt] leading-[1.5]">
      <section className="mb-8">
        <h1 className="text-[20pt] font-medium tracking-[-0.035em] text-ink">
          CV
        </h1>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="text-soft text-[9.5pt] leading-[1.55]">
